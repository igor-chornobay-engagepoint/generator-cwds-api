package gov.ca.cwds.<%=apiPackage %>.web.rest;
...
import gov.ca.cwds.<%=apiPackage %>.web.rest.utils.TestModeUtils;
...
public class RestClientTestRule implements TestRule {
  ...
  private final DropwizardAppRule<<%=apiClass %>ApiConfiguration> dropWizardApplication;

  private Client client;
  private ObjectMapper mapper;
  private String token;

  public RestClientTestRule(DropwizardAppRule<<%=apiClass %>ApiConfiguration> dropWizardApplication) {
